...
NIFTY50_STOCKS = [
    ...
    {"symbol": "TATAMOTORS.NS", "name": "Tata Motors", "display": "TATAMOTORS"},
...
def get_company(symbol):
    ...
    try:
        ...
        # Skip slow operations (quarterly_earnings, major_holders)
        # Use placeholder values - these rarely change
